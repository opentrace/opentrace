...
const webAppLinks: GraphLink[] = [
  // Directory structure (DEFINES: parent → child)
  { source: 'repo', target: 'dir-src', label: 'DEFINES' },
  { source: 'dir-src', target: 'dir-server', label: 'DEFINES' },
  { source: 'dir-src', target: 'dir-client', label: 'DEFINES' },
  { source: 'dir-server', target: 'dir-models', label: 'DEFINES' },
  { source: 'dir-server', target: 'dir-routes', label: 'DEFINES' },
  { source: 'dir-client', target: 'dir-components', label: 'DEFINES' },
  { source: 'dir-client', target: 'dir-hooks', label: 'DEFINES' },
  // Files in directories
  { source: 'dir-server', target: 'file-app', label: 'DEFINES' },
  { source: 'dir-models', target: 'file-user-model', label: 'DEFINES' },
  { source: 'dir-models', target: 'file-order-model', label: 'DEFINES' },
  { source: 'dir-routes', target: 'file-user-routes', label: 'DEFINES' },
  { source: 'dir-routes', target: 'file-order-routes', label: 'DEFINES' },
  { source: 'dir-server', target: 'file-auth-middleware', label: 'DEFINES' },
  { source: 'dir-client', target: 'file-app-tsx', label: 'DEFINES' },
  { source: 'dir-components', target: 'file-user-list', label: 'DEFINES' },
  { source: 'dir-components', target: 'file-order-table', label: 'DEFINES' },
  { source: 'dir-hooks', target: 'file-use-fetch', label: 'DEFINES' },
  // Classes & functions in files
  { source: 'file-user-model', target: 'class-user', label: 'DEFINES' },
  { source: 'file-order-model', target: 'class-order', label: 'DEFINES' },
  { source: 'file-auth-middleware', target: 'class-auth', label: 'DEFINES' },
  { source: 'file-user-routes', target: 'fn-get-users', label: 'DEFINES' },
  {
    source: 'file-order-routes',
    target: 'fn-create-order',
    label: 'DEFINES',
  },
  {
    source: 'file-auth-middleware',
    target: 'fn-validate-token',
    label: 'DEFINES',
  },
  {
    source: 'file-user-model',
    target: 'fn-hash-password',
    label: 'DEFINES',
  },
  { source: 'file-use-fetch', target: 'fn-use-fetch', label: 'DEFINES' },
  { source: 'file-user-list', target: 'fn-render-users', label: 'DEFINES' },
  {
    source: 'file-order-table',
    target: 'fn-render-orders',
    label: 'DEFINES',
  },
  // CALLS
 ...
 * edge labels (DEFINES, CALLS, IMPORTS, DEPENDS_ON).
 *
