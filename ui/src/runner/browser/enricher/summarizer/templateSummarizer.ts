...
const KEYWORD_PATTERNS: KeywordPattern[] = [
  {
    domain: "database",
    patterns: [
      /\bsql\b/i, /\bquery\b/i, /\bSELECT\b/, /\bINSERT\b/, /\bUPDATE\b.*\bSET\b/,
      /\bdb\./i, /\bcursor\b/i, /\bconnection\b/i, /\bprisma\b/i, /\bknex\b/i,
      /\bsequelize\b/i, /\bmongoose\b/i, /\bsqlx\b/i, /\borm\b/i, /\bmigration\b/i,
      /\bschema\b/i, /\btable\b/i, /\btransaction\b/i, /\bcolumn\b/i,
    ],
  },
  {
    domain: "auth",
    patterns: [
      /\bauth\b/i, /\bjwt\b/i, /\btoken\b/i, /\bpassword\b/i, /\blogin\b/i,
      /\bsession\b/i, /\boauth\b/i, /\bbcrypt\b/i, /\bcredential\b/i,
      /\bpermission\b/i, /\brole\b/i, /\bacl\b/i, /\bsignin\b/i, /\bsignup\b/i,
    ],
  },
  {
    domain: "http",
    patterns: [
      /\bhttp\b/i, /\brequest\b/i, /\bresponse\b/i, /\bfetch\s*\(/i, /\baxios\b/i,
      /\bhandler\b/i, /\bmiddleware\b/i, /\bcors\b/i, /\bendpoint\b/i,
      /\broute\b/i, /\bREST\b/i, /\bgraphql\b/i, /\bheader\b/i,
    ],
  },
  {
    domain: "filesystem",
    patterns: [
      /\bfs\./i, /\breadFile\b/i, /\bwriteFile\b/i, /\bpath\./i,
      /\bstream\b/i, /\bbuffer\b/i, /\bmkdir\b/i, /\bunlink\b/i, /\bglob\b/i,
    ],
  },
  {
    domain: "crypto",
    patterns: [
      /\bcrypto\b/i, /\bencrypt\b/i, /\bdecrypt\b/i, /\bhash\b/i,
      /\bsign\b/i, /\bverify\b/i, /\bcipher\b/i, /\bhmac\b/i,
    ],
  },
  {
    domain: "cache",
    patterns: [
      /\bcache\b/i, /\bredis\b/i, /\bmemcached\b/i, /\bttl\b/i,
      /\binvalidate\b/i, /\bLRU\b/i,
    ],
  },
  {
    domain: "queue",
    patterns: [
      /\bqueue\b/i, /\bworker\b/i, /\bjob\b/i, /\bpublish\b/i,
      /\bsubscribe\b/i, /\bkafka\b/i, /\brabbitmq\b/i, /\bamqp\b/i,
    ],
  },
  {
    domain: "config",
    patterns: [
      /\bconfig\b/i, /\benv\b/i, /\bsettings\b/i, /\byaml\b/i, /\bdotenv\b/i, /\.env\b/i,
    ],
  },
  {
    domain: "logging",
    patterns: [
      /\blogger\b/i, /\bwinston\b/i, /\bpino\b/i, /\blogrus\b/i, /\bslog\b/i, /\blog\./i,
    ],
  },
  {
    domain: "testing",
    patterns: [
      /\btest\b/i, /\bassert\b/i, /\bexpect\b/i, /\bmock\b/i,
      /\bstub\b/i, /\bspy\b/i, /\bfixture\b/i, /\bjest\b/i, /\bpytest\b/i,
    ],
  },
  {
    domain: "async",
    patterns: [
      /\basync\b/i, /\bawait\b/i, /\bPromise\b/, /\bgoroutine\b/i,
      /\bchannel\b/i, /\bconcurrent\b/i, /\bparallel\b/i, /\bmutex\b/i,
    ],
  },
  {
    domain: "error",
    patterns: [
      /\btry\b/, /\bcatch\b/, /\bthrow\b/, /\bError\b/, /\bpanic\b/i,
      /\brecover\b/i, /\berrno\b/i,
    ],
  },
  {
    domain: "validation",
    patterns: [
      /\bvalidate\b/i, /\bsanitize\b/i, /\bzod\b/i,
      /\byup\b/i, /\bjoi\b/i, /\bregexp\b/i, /\bregex\b/i,
    ],
  },
  {
    domain: "websocket",
    patterns: [
      /\bwebsocket\b/i, /\bws\./i, /\bsocket\b/i, /\bWebSocket\b/, /\bemit\s*\(/i,
    ],
  },
  {
    domain: "email",
    patterns: [
      /\bemail\b/i, /\bsmtp\b/i, /\bsendmail\b/i, /\bmailer\b/i,
    ],
  },
];
...
const CONSTRUCTOR_NAMES = new Set(["__init__", "constructor", "init", "initialize", "New"]);
...
function isNonDescriptive(name: string): boolean {
  ...
  return ["foo", "bar", "baz", "tmp", "temp", "x", "y", "z", "fn", "cb", "f", "g"].includes(lower);
}
...
export function summarizeFunction(
  ...
  if (lowerName.startsWith("test_") || lowerName.startsWith("test")) {
    ...
    const testWords = words[0].toLowerCase() === "test" ? words.slice(1) : words;
...
const CRUD_METHODS = new Set(["create", "read", "get", "find", "update", "delete", "remove", "save", "list"]);
...
export function summarizeClass(
  ...
  if (childNames && childNames.length > 0) {
    const lowerChildren = childNames.map((c) => splitIdentifier(c)[0].toLowerCase());
...
export class TemplateSummarizer implements Summarizer {
  ...
  async summarizeBatch(
    ...
    return Promise.all(items.map((item) => this.summarize(item.source, item.kind)));
  }
