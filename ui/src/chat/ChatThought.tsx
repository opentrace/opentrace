  ...
  return (
    <details className="chat-thought">
      <summary className="thought-summary">
        <svg className="thought-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <span className="thought-preview">{preview}{part.content.length > 80 ? "\u2026" : ""}</span>
      </summary>
