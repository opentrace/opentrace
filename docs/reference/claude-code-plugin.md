...
The plugin source lives in `plugins/claude-code/` in the repository root. See the README in that directory for plugin structure, versioning, and agent development.
