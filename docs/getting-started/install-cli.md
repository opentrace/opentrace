...
opentrace index --extract-entities /path/to/repo       # also extract entities from code + docs
opentrace index --build-pages /path/docs foo           # compile a curated wiki vault
